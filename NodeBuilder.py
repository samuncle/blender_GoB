...
class BuildNodes(bpy.types.Operator):
    ...
    def create_normal_node(self, pos_x=-650, pos_y=-400):
        ...
        self.material.node_tree.links.new(self.shader_node.inputs[19], self.normal_node.outputs[0])  # TODO: find index by input name
    ...
    def create_displacement_node(self, pos_x=-300, pos_y=-600):
        ...
        self.material.node_tree.links.new(self.output_node.inputs[2], self.displacement_node.outputs[0])
